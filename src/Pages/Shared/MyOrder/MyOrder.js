    ...
    return (
        <div>
            {products.filter(product => sunglass_id === product._id).map(order => <div className="lg:flex items-baseline justify-end">
                ...
                {confirmed ? <p className="p-2 pl-5 pr-5 bg-blue-500 text-gray-100 text-lg rounded-lg focus:border-4 border-blue-300">Shipped</p> : <p className="p-2 pl-5 pr-5 bg-yellow-500 text-gray-100 text-lg rounded-lg focus:border-4 border-yellow-300">Pending</p>
                }
